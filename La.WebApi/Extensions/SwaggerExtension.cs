        ...
        public static void AddSwaggerConfig(this IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                try
                {
                    ...
                    c.IncludeXmlComments(Path.Combine(baseDir, "La.ServiceCore.xml"), true);
                    c.IncludeXmlComments(Path.Combine(baseDir, "La.Service.xml"), true);
                    c.IncludeXmlComments(Path.Combine(baseDir, "La.WebApi.xml"), true);
