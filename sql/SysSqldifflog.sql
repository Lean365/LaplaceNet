...
VALUES ('差异日志', 108, 999, 'SysSqldifflog', 'office/SysSqldifflog', 0, 0, 'C', '0', '0', 'sys:sqldifflog:list', 'icon1', 'system', GETDATE());
...
INSERT INTO sys_menu(menuName, parentId, orderNum, path, component, isFrame, isCache, menuType, visible, IsStatus, perms, icon, create_by,create_time) 
VALUES ('修改', @menuId, 4, '#', NULL, 0, 0, 'F', '0', '0', 'sys:sqldifflog:edit', '', 'system', GETDATE());
INSERT INTO sys_menu(menuName, parentId, orderNum, path, component, isFrame, isCache, menuType, visible, IsStatus, perms, icon, create_by,create_time) 
